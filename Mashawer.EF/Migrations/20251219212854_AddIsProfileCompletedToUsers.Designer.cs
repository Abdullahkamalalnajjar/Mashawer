...
namespace Mashawer.EF.Migrations
{
    ...
    [Migration("20251219212854_AddIsProfileCompletedToUsers")]
    partial class AddIsProfileCompletedToUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mashawer.Data.Entities.ClasssOfOrder.ClientCancelOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mashawer.Data.Entities.ClasssOfOrder.OrderTask", b =>
                {
                    ...
                    b.Property<string>("GoogleMapAddressFrom")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("GoogleMapAddressTo")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Mashawer.Data.Entities.ClasssOfOrder.RepresentitiveCancelOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mashawer.Data.Entities.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mashawer.Data.Entities.Rating", b =>
                {
                    b.HasOne("Mashawer.Data.Entities.ApplicationUser", "RatedBy")
                        .WithMany()
                        .HasForeignKey("RatedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Mashawer.Data.Entities.ApplicationUser", "RatedUser")
                        .WithMany()
