...
namespace Mashawer.EF.Migrations
{
    ...
    [Migration("20251124184420_datetimeordertask")]
    partial class datetimeordertask
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Mashawer.Data.Entities.ClasssOfOrder.RepresentitiveCancelOrder", b =>
                {
                    ...
                    b.Property<string>("RepresentitiveId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Mashawer.Data.Entities.ClasssOfOrder.RepresentitiveCancelOrder", b =>
                {
                    ...
                    b.HasOne("Mashawer.Data.Entities.ApplicationUser", "Representitive")
                        .WithMany()
                        .HasForeignKey("RepresentitiveId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
